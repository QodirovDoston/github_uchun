        ...
        <div className='container '>
            <Row className='sm:grid gap-[599px] grid-cols-3 grid-rows-3 sm:ml-0 ml-1 '>
                {age.map((item) => {
                     return (
                         <>
                            <Col  key={item.id} item={ item } handleClick={handleClick}  className='sm:mb-[-600px] mb-[0px]'>
                                <div className="  sm:w-[390px] w-[290px]  sm:h-[590px] h-[390px] mt-7  bg-white rounded-[40px] shadow-2xl">
                                    ...
                                    <div className="flex sm:gap-2 gap-0 sm:m-4 m-1">
                                        ...
                                        <button onClick={() => handleClick(item)} className=' sm:ml-[180px]  ml-[120px] sm:w-[100px] w-[100px] text-white  sm:h-[41px]  h-[28px] rounded-[4px] 
